export default async function handler(req, res) {
  ...
  const skjemaLenke = 'https://airtable.com/appM5wdT9AbJ1YRCy/pagn82j7SxaUHEDCP/form';

  const smsBody = `Hei ${fornavn}! Vi gleder oss til å jobbe med ${bedriftsnavn || 'dere'}.\nHer er lenken for å komme i gang — tar under to minutter:\n${skjemaLenke}`;
  ...
  try {
    ...
    console.log('SMS SALG:', smsStatus, twilioData.sid || twilioData.message);
  } catch (err) {
