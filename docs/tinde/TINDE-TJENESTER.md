...
| Rekruttering (20 ansatte) | CV-screening og kandidat-matching | 15 timer/uke |
| Entreprenør (50 ansatte) | Prosjektdokumentasjon og rapportering | 10 timer/uke |
...
- Innhold: Hva AI kan (og ikke kan), live-demoer med Claude/ChatGPT, hands-on øvelser med deltakernes egne arbeidsoppgaver
- Resultat: Hver deltaker går hjem med 3 konkrete ting de kan gjøre med AI mandag morgen

**"Claude for kunnskapsarbeidere"**
- For: Ansatte som jobber med tekst, analyse, kommunikasjon
- Innhold: Prompting-teknikker, dokumentanalyse, skriving, oppsummering, oversettelse
- Resultat: Deltakerne mestrer det viktigste AI-verktøyet for kunnskapsarbeid

**"AI for ledere"**
- For: Daglige ledere, avdelingsledere, styremedlemmer
- Innhold: Strategisk perspektiv, business case for AI, risiko og personvern, hvordan lede AI-adopsjon
- Resultat: Ledelsen forstår nok til å ta gode beslutninger om AI-investering

**"Bygg med AI" — teknisk workshop**
- For: Utviklere og teknisk personale
- Innhold: AI SDK, API-integrasjoner, Claude Code, automatisering, agenter
- Resultat: Deltakerne kan bygge AI-drevne verktøy og automatiseringer
...
| Prosjekt | Beskrivelse | Typisk pris |
|----------|-------------|-------------|
| Automatisk tilbudsberegning | AI som estimerer pris fra bilder/beskrivelse | 50 000 – 100 000 kr |
